package com.madd.madd.tmdb.Data.ContentList.Source.Remote;
...
public class ContentListRemoteDataSource implements ContentListDataSource.Remote {
    ...
    @Override
    public void getMovieListByQuery(String query, int page, ContentListDataSource.GetContentList getContentList) {
    ...
    @Override
    public void getTVShowListByQuery(String query, int page, ContentListDataSource.GetContentList getContentList) {
